...
All methods require ‘self’ parameter. If you have coded in other OOP language you can think of ‘self’ as
the ‘this’ keyword which is used for the the current object. It unhides the current instance variable.’self’
